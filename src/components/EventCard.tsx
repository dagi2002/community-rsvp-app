      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center space-x-1 bg-purple-50 px-3 py-1 rounded-full">
            ...
            <span className="text-purple-700 font-semibold text-sm">{totalAttendees}</span>
          </div>
        </div>
        ...
        <Link
          ...
          className="block w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white text-center py-3 rounded-xl font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
        >
          RSVP Now
        </Link>
      </div>
